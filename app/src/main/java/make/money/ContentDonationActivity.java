...
public class ContentDonationActivity extends BaseActivity 
{
	@Override
	public void onCreate(Bundle savedInstanceState) 
	{
	    ...
	    {  
	        ...
	        {	        	
	            Intent myIntent = new Intent(ContentDonationActivity.this, AddPlanActivity.class);
	            ContentDonationActivity.this.startActivity(myIntent);
	        }
	    });     
...
//	    public void onClick(View v) 
//	    {
//	        //sendEmail("From Learn --> Marketing Strategies", "From learn page, user clicked on marketing strategies" );   	
//	    	
//	        Intent myIntent = new Intent(LearnActivity.this, AdvertisingActivity.class);
