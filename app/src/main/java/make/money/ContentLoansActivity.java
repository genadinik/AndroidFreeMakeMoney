...
public class ContentLoansActivity extends BaseActivity
{
	@Override
	public void onCreate(Bundle savedInstanceState) 
	{
	    ...
	    Button lendio = (Button)findViewById(R.id.lendio);          
	    lendio.setOnClickListener(new Button.OnClickListener() 
	    {  
...
//	    Button curedebt = (Button)findViewById(R.id.curedebt);          
//	    curedebt.setOnClickListener(new Button.OnClickListener() 
//	    {  
//	        public void onClick(View v) 
//	        {	        	
//  	            Intent browserIntent = new Intent(Intent.ACTION_VIEW, 
//    	          		  Uri.parse("http://www.kqzyfj.com/click-7252177-10974629"));
//    	            startActivity(browserIntent);
//	        }
//	    });          	    
	    ...
	    {  
	        public void onClick(View v) 
	        {	        	
	            Intent myIntent = new Intent(ContentLoansActivity.this, AddPlanActivity.class);
	            ContentLoansActivity.this.startActivity(myIntent);
	        }
	    });          
