...
public class CreativeFundraisingActivity extends BaseActivity
{
	@Override
	public void onCreate(Bundle savedInstanceState) 
	{
	    super.onCreate(savedInstanceState);
	    setContentView(R.layout.creative_fundraising);
	    ...
	    {  
	        ...
	        {	        	
	            Intent myIntent = new Intent(CreativeFundraisingActivity.this, AddPlanActivity.class);
	            CreativeFundraisingActivity.this.startActivity(myIntent);
	        }
	    });     
