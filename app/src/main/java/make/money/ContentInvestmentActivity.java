...
public class ContentInvestmentActivity extends BaseActivity
{
	@Override
	public void onCreate(Bundle savedInstanceState) 
	{
	    ...
	    {  
	        ...
	        {	        	
	            Intent myIntent = new Intent(ContentInvestmentActivity.this, AddPlanActivity.class);
	            ContentInvestmentActivity.this.startActivity(myIntent);
	        }
	    });     
